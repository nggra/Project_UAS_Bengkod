...
# This line should be moved later after best_rf is defined
...
# Gabungkan X_resampled dan y_resampled ke dalam satu DataFrame
...
# Now save the best model after it's been defined
joblib.dump(best_rf, "random_forest_model.pkl")
